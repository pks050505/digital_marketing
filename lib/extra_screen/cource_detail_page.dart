...
class CourceDetailScreen extends StatefulWidget {
  static const routeName = 'cource_detail_scree ';
  ...
  static MaterialPageRoute route({required CourceModel courceModel}) {
    return MaterialPageRoute(
      settings: const RouteSettings(name: routeName),
      builder: (_) => CourceDetailScreen(courceModel: courceModel),
    );
  }
...
class _CourceDetailScreenState extends State<CourceDetailScreen>
  ...
  Widget build(BuildContext context) {
    ...
    var tabcontoller = TabController(length: 2, vsync: this);
                ...
                child: Column(
                  children: [
                    ...
                    Expanded(
                      ...
                      controller: tabcontoller,
                      children: [
                        const LessionsTabView(),
                        AboutTabView(courceModel: widget.courceModel),
                      ],
                    ))
                  ],
                ),
